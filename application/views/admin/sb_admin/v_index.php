    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!--            </div>-->
                <!-- /.row -->
                <!-- Tambahkan tombol di dalam bagian header atau footer sesuai kebutuhan -->

                <?php $this->load->view('admin/' . $this->session->userdata('theme') . '/page/' . $page); ?>

                <!-- Conditionally display the Print All button -->
                <?php if (isset($active_id_menu) && $active_id_menu == "Pasien") : ?>
                    <div class="toolbar">
                        <a href="<?= $print_url ?>" class="btn btn-primary">Print All</a>
                    </div>
                <?php endif; ?>
            </div>
            <!-- /.container-fluid -->
